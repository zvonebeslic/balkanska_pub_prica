...
# HTML block before upcoming collections
anchor='''        <section class="player-upcoming-card player-upcoming-card--collections">'''
...
# Helper before updatePlayerStatsUI
